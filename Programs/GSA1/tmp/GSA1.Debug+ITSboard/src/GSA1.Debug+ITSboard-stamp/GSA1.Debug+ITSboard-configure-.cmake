...
set(stderr_log "C:/GS_Labor/ITS-BRD-VSC/Programs/GSA1/tmp/GSA1.Debug+ITSboard/src/GSA1.Debug+ITSboard-stamp/GSA1.Debug+ITSboard-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  C:/GS_Labor/ITS-BRD-VSC/Programs/GSA1/tmp/GSA1.Debug+ITSboard/src/GSA1.Debug+ITSboard-stamp/GSA1.Debug+ITSboard-configure-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "GSA1.Debug+ITSboard configure command succeeded.  See also C:/GS_Labor/ITS-BRD-VSC/Programs/GSA1/tmp/GSA1.Debug+ITSboard/src/GSA1.Debug+ITSboard-stamp/GSA1.Debug+ITSboard-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
