...
void outputChange(double currentAngle, double angleSpeed){
    // Umwandlung der double-Werte in Strings
    snprintf(currentAngleStr, sizeof(currentAngleStr), "%11.1f", currentAngle);
    snprintf(speedStr, sizeof(speedStr), "%11.1f", angleSpeed);
