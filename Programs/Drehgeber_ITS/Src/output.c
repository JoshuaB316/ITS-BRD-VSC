...
void setErrorLED(bool on) { setPin(LED_REG_INFO, OFFSET_ERROR_LED, on); }

void setForwardLED(bool on) { setPin(LED_REG_INFO, OFFSET_FORWARD_LED, on); }

void setBackwardLED(bool on) { setPin(LED_REG_INFO, OFFSET_BACKWARD_LED, on); }

void setLED_GPIOG_1(bool on) { setPin(LED_REG_INFO, OFFSET_TIME_MEA_1, on); }

void setLED_GPIOG_2(bool on) { setPin(LED_REG_INFO, OFFSET_TIME_MEA_2, on); }
